  ...
  return (
    <section className="relative py-32 bg-ivory overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-6 lg:px-12 text-center">
        <FadeIn>
          <p className="text-lg uppercase tracking-[0.2em] text-secondary mb-6">
            Ready to Start?
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold text-slate-dark leading-tight">
            ...
            <span className="text-primary">Infrastructure Together</span>
          </h2>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <MagneticButton>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-3 px-10 py-5 bg-primary text-white font-medium tracking-wide transition-all duration-500 hover:shadow-lg hover:scale-[1.02]"
              >
                Start Your Project
                <svg 
            ...
            <MagneticButton>
              <Link
                ...
                className="inline-flex items-center gap-3 px-10 py-5 border-2 border-slate-dark/20 text-slate-dark font-medium tracking-wide transition-all duration-500 hover:border-primary hover:text-primary"
              >
